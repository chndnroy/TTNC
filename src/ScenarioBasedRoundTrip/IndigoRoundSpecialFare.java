...
public class IndigoRoundSpecialFare extends LoginTest{
	@Test
	public void RoundConnectingFlight() throws InterruptedException {
		...
		fp.RoundTripLCCInput(ExcelUtils.readData("Sheet3", 0, 2), ExcelUtils.readData("Sheet3", 1, 2));
		fp.preferredAirlineRoundtripselect(ExcelUtils.readData("sheet3", 2, 2));
